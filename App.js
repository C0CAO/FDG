...
const PaginaRacao = ({ itens, setItens, onVoltar, usuario, historico, setHistorico }) => {
    ...
    if (subpagina === "Todas Rações") {
        return React.createElement(TodasRacoes, { itens, setItens, historico, setHistorico, usuario, onVoltar: () => setSubpagina(null) });
    }
...
const PaginaGalinhas = ({ itens, setItens, onVoltar, usuario, historico, setHistorico }) => {
    ...
    if (subpagina === "Galinhas Cadastradas") {
        return React.createElement(GalinhasCadastradas, { itens, setItens, historico, setHistorico, usuario, onVoltar: () => setSubpagina(null) });
    }
    ...
    return React.createElement("div", { className: "container" },
        ...
        React.createElement("button", { className: "botao", style: { marginBottom: "10px" }, onClick: () => setSubpagina("Galinhas Cadastradas") }, "Todas Galinhas"),
        React.createElement("button", { className: "botao", style: { marginTop: "20px", background: "#444" }, onClick: onVoltar }, "← Voltar")
    );
};
...
const PaginaOvos = ({ onVoltar, usuario, itensRacao, itensGalinhas, historico, setHistorico, coletas, setColetas }) => {
    ...
    return React.createElement("div", { className: "container" },
        ...
        React.createElement("button", { className: "botao", style: { marginBottom: "10px" }, onClick: () => setSubpagina("Todas Coletas") }, "Todas Coletas"),
        // React.createElement("button", { className: "botao", style: { marginBottom: "10px" }, onClick: () => setSubpagina("Venda") }, "Venda"),
        React.createElement("button", { className: "botao", style: { marginTop: "20px", background: "#444" }, onClick: onVoltar }, "← Voltar")
    );
};
...
const PaginaHistoricoGeral = ({ historicoRacao, historicoGalinhas, historicoOvos, onVoltar }) => {
...
const NovaVenda = ({ vendas, setVendas, historico, setHistorico, usuario, onVoltar }) => {
    ...
    return React.createElement("div", { className: "container" },
        ...
        React.createElement("div", { style: { background: "#f9f9f9", border: "1px solid #ddd", borderRadius: "8px", padding: "12px", marginBottom: "16px" } },
            React.createElement("input", { type: "text", placeholder: "Produto (ex: Ovos, Galinha)", value: form.produto, onChange: (e) => setField("produto", e.target.value), className: "input", style: inputStyle }),
            React.createElement("input", { type: "number", placeholder: "Quantidade", value: form.quantidade, onChange: (e) => setField("quantidade", e.target.value), className: "input", style: inputStyle }),
...
const PaginaVendas = ({ vendas, setVendas, onVoltar, usuario, historico, setHistorico }) => {
    const [subpagina, setSubpagina] = useState(null);

    if (subpagina === "Nova Venda") {
        return React.createElement(NovaVenda, { vendas, setVendas, historico, setHistorico, usuario, onVoltar: () => setSubpagina(null) });
    }
...
const Dashboard = ({ onSair, usuario, perfilAtivo, usuarios, setUsuarios }) => {
    ...
    const topicos = ["Ração", "Galinhas", "Ovos", "Analytics", "Vendas"];
    ...
    if (paginaAtiva === "Histórico") {
        return React.createElement(PaginaHistoricoGeral, { historicoRacao, historicoGalinhas, historicoOvos, onVoltar: () => setPaginaAtiva(null) });
    }

    if (paginaAtiva === "Vendas") {
        return React.createElement(PaginaVendas, { vendas, setVendas, onVoltar: () => setPaginaAtiva(null), usuario, historico: historicoVendas, setHistorico: setHistoricoVendas });
    }

    return React.createElement("div", { className: "container" },
        // React.createElement("img", { src: "logo.png", alt: "Logo", style: { width: "80px", height: "80px", objectFit: "contain", display: "block", margin: "0 auto 8px auto" } }),
        ...
        React.createElement("div", { style: { display: "flex", gap: "8px", marginTop: "20px" } },
            React.createElement("button", { className: "botao", style: { background: "#555", flex: "none", padding: "12px 16px", width: "auto" }, onClick: () => setPaginaAtiva("Configurações") }, "⚙"),
            React.createElement("button", { className: "botao", style: { background: "#8b0000", flex: 1 }, onClick: onSair }, "Sair"),          
        ),
        (
